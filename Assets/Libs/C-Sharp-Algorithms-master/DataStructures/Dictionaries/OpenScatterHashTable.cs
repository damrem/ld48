...
namespace DataStructures.Dictionaries
{
    ...
    public class OpenScatterHashTable<TKey, TValue> : IDictionary<TKey, TValue> where TKey : IComparable<TKey>
    {
        ...
        /// Hash Table Cell.
        /// </summary>
        private class HashTableEntry<TEntryKey, TEntryValue> where TEntryKey : IComparable<TEntryKey>
        {
            public TEntryKey Key { get; set; }
            public TEntryValue Value { get; set; }
            public EntryStatus Status { get; set; }

            public HashTableEntry() : this(default(TEntryKey), default(TEntryValue)) { }
