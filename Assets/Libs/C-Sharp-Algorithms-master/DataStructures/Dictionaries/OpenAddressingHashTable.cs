...
namespace DataStructures.Dictionaries
{
    ...
    public class OpenAddressingHashTable<TKey, TValue> : IDictionary<TKey, TValue> where TKey : IComparable<TKey>
    {
        ...
        /// </summary>
        /// <typeparam name="TEntryKey"></typeparam>
        /// <typeparam name="TEntryValue"></typeparam>
        private class OAHashEntry<TEntryKey, TEntryValue> where TEntryKey : IComparable<TEntryKey>
        {
            public TEntryKey key { get; set; }
            public TEntryValue value { get; set; }
            public bool occupied { get; set; }
            public OAHashEntry(TEntryKey Key, TEntryValue Value, bool occp)
            {
                key = Key;
                value = Value;
                occupied = occp;
