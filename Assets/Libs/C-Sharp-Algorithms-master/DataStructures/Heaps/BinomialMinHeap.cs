...
namespace DataStructures.Heaps
{
    ...
    public class BinomialMinHeap<T> : IMinHeap<T> where T : IComparable<T>
    {
        ...
        /// The Heap Node class.
        /// </summary>
        private class BinomialNode<TNodeValue> where TNodeValue : IComparable<TNodeValue>
        {
            public TNodeValue Value { get; set; }
            public BinomialNode<TNodeValue> Parent { get; set; }
            public BinomialNode<TNodeValue> Sibling { get; set; }    // Right-Sibling
            public BinomialNode<TNodeValue> Child { get; set; }      // Left-Child

            // Constructors
            public BinomialNode() : this(default(TNodeValue), null, null, null) { }
            public BinomialNode(TNodeValue value) : this(value, null, null, null) { }
            public BinomialNode(TNodeValue value, BinomialNode<TNodeValue> parent, BinomialNode<TNodeValue> sibling, BinomialNode<TNodeValue> child)
            {
                Value = value;
                Parent = parent;
                Sibling = sibling;
